...
export const JiraStatsGaugeWidget: FC<BasicWidgetProps & {jql: string}> = ({ title, widget, dashboard, jql }) => {
  return <GeneralApiData<JiraSprintGaugeResponse>
    endpoint={`/api/jira/stats/gauge?dashboard=${dashboard}&widget=${widget}`}
    identifier={'key'}
  >
